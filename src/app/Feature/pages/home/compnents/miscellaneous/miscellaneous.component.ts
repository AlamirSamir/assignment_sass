...
import { MealsByNameService } from '../../../../../Shared/interfaces/services/mealsByName/meals-by-name.service';
...
export class MiscellaneousComponent implements OnInit, OnDestroy {
  ...
  getdata() {
    this.subGetdata = this._mealsByNameService
      .getMealsByName('miscellaneous')
      .subscribe({
